...
class AuthFirebaseService implements AuthService {
  static CampoUser? _currentUser;

  static final _userStream = Stream<CampoUser?>.multi((controller) async {
  ...
  Future<void> _saveToDoUser(CampoUser user) async {
  ...
  static CampoUser _toDoUser(User user, [String? imageURL]) {
    return CampoUser(
      id: user.uid,
